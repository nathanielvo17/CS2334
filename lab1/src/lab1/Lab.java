...
public class Lab 
{
    ...
    /**
      ...
      @param input | String input of format: "lab_name#number_of_students#number_of_teaching_assistants"
    */
    public Lab(String input) 
    {   
        //  Temporary String array to split input based on "#"
        String temp[] = input.split("#");
        //  for loop that initializes the data array to the split temporary array 
        for (int i = 0; i < 3; i++) 
        {
            data[i] = temp[i];
        }
